...
get1<-c("ATRAvsDMSO","PMAvsDMSO","vitDvsDMSO")
toget<-paste0(outdir,"limma_transcripts_",get1[3],"_raw",".csv")
print(toget)
...
tosep<-tosep-1
tosep
heatres<-as.matrix(resultskk[,c("ATRAvsDMSO","PMAvsDMSO","vitDvsDMSO")])
colnames(heatres)<-c("ATRA", "PMA","vitD")
heatres
#numbered heatmap
heatmap.2(heatres,
